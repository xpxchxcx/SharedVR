...
public class PlaceCharacter : NetworkBehaviour
{
    ...
    private void Start()
    {
        // to switch between ar and normal game
    ...
    void TouchToRay(Vector3 touch)
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            SpawnPlayerServerRpc(hit.point, rot, NetworkManager.Singleton.LocalClientId);

        }
    }


    [ServerRpc(RequireOwnership = false)] //any client can call method
